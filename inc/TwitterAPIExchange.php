...
class TwitterAPIExchange
{
    ...
    public function performRequest($return = true, $curlOptions = array())
    {
       ...
       //return $json;
        ...
        $text = $twitterData[0]['text'];
        $date = $twitterData[0]['created_at'];
        $twProfile = get_field('twitter_profile', 'options');
        $newDate = substr($date, 3, 7);


        echo '<a href="' . $twProfile . '"><div>' .
                    '<p class="social-type"><i class="fa fa-twitter" aria-hidden="true"></i></p>' .
                    '<p>' . $text . '</p><p class="date">' . $newDate . '</p>' .
                    '</div></a>';
    }
    /**
