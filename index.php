			...
			<?php
				...
				<div class="inner-wrapper instruction__innerWrapper">
					...
					<div class="instruction__innerWrapper__image">
						<svg class="phone-frame" viewBox="0 0 349 698" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
						    <defs>
						        <path d="M162.5,674 L273.375,674 C281.183,674 288.929,672.259 295.859,668.662 C305.415,663.703 312.927,656.862 318.242,648.001 C322.778,640.439 325,631.712 325,622.894 L325,51.106 C325,42.288 322.778,33.561 318.242,25.999 C312.927,17.137 305.415,10.297 295.859,5.338 C288.929,1.741 281.183,0 273.375,0 L162.5,0 L51.625,0 C43.817,0 36.072,1.741 29.141,5.338 C19.585,10.297 12.073,17.137 6.758,25.999 C2.222,33.561 0,42.288 0,51.106 L0,622.894 C0,631.712 2.222,640.439 6.758,648.001 C12.073,656.862 19.585,663.703 29.141,668.662 C36.072,672.259 43.817,674 51.625,674 L162.5,674 Z" id="path-<?php echo $count; ?>"></path>
						        <filter x="-6.2%" y="-2.4%" width="112.3%" height="105.9%" filterUnits="objectBoundingBox" id="filter-<?php echo $count; ?>-2">
						    ...
						    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						        <g transform="translate(11.000000, 8.000000)">
						            <g transform="translate(1.000000, 0.000000)">
						                <g id="Fill-1">
						                    <use fill="black" fill-opacity="1" filter="url(#filter-<?php echo $count; ?>-2)" xlink:href="#path-<?php echo $count; ?>"></use>
						                    <use fill="#D1E4F1" fill-rule="evenodd" xlink:href="#path-<?php echo $count; ?>"></use>
						                </g>
						                <path d="M308.5,596 L16.5,596 C14.3,596 12.5,594.2 12.5,592 L12.5,80 C12.5,77.8 14.3,76 16.5,76 L308.5,76 C310.7,76 312.5,77.8 312.5,80 L312.5,592 C312.5,594.2 310.7,596 308.5,596" fill="url(#img_<?php echo $count; ?>)"></path>
				...
				<div class="instruction__bottomBar instruction__bottomBar--<?php echo $state; ?> container">
					<div class="instruction__bottomBar__nav inner-wrapper">
						<div class="instruction__bottomBar__nav__content">
							<a class="instruction__bottomBar__nav__content__link" href="">
								<p>
								<?php if (!$endOfModules) { 
									echo 'Continue'; 
								} else { 
